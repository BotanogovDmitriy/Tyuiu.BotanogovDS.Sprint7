...
namespace Tyuiu.BotanogovDS.Sprint7.V8.Lib
{
    public class DataService
    {
        ...
        public bool Exist(string path, string series, int NumColumns)
        {
            ...
            for (int i = 1; i < strLines.Length; i++)
            {
                ...
                {
                    if (series == strElment[NumColumns])
                        res = true;
                }
            }
            return res;
